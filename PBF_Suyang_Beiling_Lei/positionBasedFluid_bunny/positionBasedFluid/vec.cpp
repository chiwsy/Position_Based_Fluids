...
// CONSTRUCTORS
	...
	vec3::vec3()
#else
	vec3::vec3():_x(n[VX]),_y(n[VY]),_z(n[VZ])
#endif
{
	n[VX] = 0.0; 
	n[VY] = 0.0; 
...
#else
	vec3::vec3(const double x, const double y, const double z):_x(n[VX]),_y(n[VY]),_z(n[VZ])
#endif
{ 
...
#else
	vec3::vec3(const vec3& v):_x(n[VX]),_y(n[VY]),_z(n[VZ])
#endif
{ 
